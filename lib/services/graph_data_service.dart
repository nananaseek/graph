...
class GraphDataService {
  ...
  /// Calculates the total money generated by all descendants of a node.
  double getDescendantsMoney(String nodeId) {
    return _calculateDescendantsMoney(nodeId);
  }

  double _calculateDescendantsMoney(String nodeId) {
    double total = 0.0;
    final children = getChildren(nodeId);
    for (final child in children) {
      total += child.selfGeneratedMoney;
      total += _calculateDescendantsMoney(child.id);
    }
    return total;
  }
